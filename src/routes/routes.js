...
routes.post('/allmural', ForumController.FindAllMural)

routes.post('/createmural', auth, ForumController.CreateMural)
routes.post('/curtidamural', auth, ForumController.CurtidaMural)
