...
routes.post('/session', UserController.SessionValidate) //rota para verificar se a sessão é valida
...
routes.post('/activetime', auth, UserController.ActivedTime) //rota para ativar ou desativar os horarios e atualiza-los também.
